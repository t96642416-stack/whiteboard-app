...
1. 아이디어 파일에 관련 문장이 있으면 원문을 직접 인용하세요. 파일명은 쓰지 마세요.
   ...
   형식: "원문 그대로 발췌" → 해석/의미 (파일 내 출처명, 연도)
   예시: "소음 관련 공식 민원: 2021년 68건 → 2024년 156건" → 소셜존 지정으로 역방향 감소 기대 (학내 시설기획팀 설문조사, 2024)
   예시(출처 없을 때): "카페처럼 자유롭게 대화할 수 있는 공간이 필요하다" → 소음 허용 공간 분리가 핵심임을 보여줌
