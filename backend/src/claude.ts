...
1. 참고 자료에 관련 문장이 있으면 원문을 직접 인용하세요.
   ...
   잘못된 예: "내용" (A안) ← 라벨 금지
2. 참고 자료에 없는 근거는 "추가 근거: "를 앞에 붙이고 괄호로 출처 표기하세요.
   형식: 추가 근거: 내용 (분야, 연도)
...
- description은 절대로 카드 제목/내용을 그대로 복사하거나 요약하면 안 됩니다. 반드시 근거(인용 또는 추가 근거) 형식으로만 작성하세요.
- 참고 자료나 파일이 있으면: "원문 발췌" (출처, 연도) 형식
- 참고 자료가 없거나 해당 효과에 맞는 내용이 없으면: 추가 근거: 내용 (분야, 연도) 형식
- (A안), (B안), (C안) 등 아이디어 라벨을 출처로 절대 쓰지 마세요.

추가 필드 규칙:
- title: 효과/개선과제 이름 (15자 이내 간결한 명사형). 개선 과제는 "~필요", "~어려움", "~과제" 등으로 표현.
- note: 참고 자료에 언급된 유사 사례나 출처. 없으면 빈 문자열("").
- similarCase: 참고 자료에서 직접 언급된 유사 사례만. 없으면 "추가 근거: " 접두어 붙인 일반 사례.
  ...
  "ideas": [
    {
      ...
      "label": "아이디어 A",
      "effects": [
        {"label": "예상효과 1", "title": "소음 갈등 완화", "description": "\"소음 민원 2021년 68건→2024년 156건\" (학내 시설기획팀, 2024)", "note": ""},
        {"label": "예상효과 2", "title": "협업 공간 확보", "description": "추가 근거: 그룹 활동 전용 공간은 팀 커뮤니케이션 효율 향상 (공간 디자인 연구, 2022)", "note": ""},
        {"label": "예상효과 3", "title": "경계 관리 어려움", "description": "추가 근거: 공간 구분 없이 운영 시 이용자 간 갈등 재발 가능성 (시설운영 연구, 2021)", "note": ""}
      ],
      "similarCase": "추가 근거: 대학 도서관 스터디룸 분리 운영 후 소음 갈등 감소 (대학시설관리, 2023)"
    }
  ],
  "commonalities": ["공통점1", "공통점2"],
  "differences": ["차이점1", "차이점2"]
...
- 각 아이디어마다 하나의 카드를 만드세요 (아이디어 수 = criteriaResults 수)
- criterion: 해당 아이디어의 전략적 성격을 나타내는 상위 라벨 (예: "안전한 선택", "파급력", "과감한 도전", "현실적 타협", "혁신형" 등 — 6자 이내 명사형)
- winner: 해당 아이디어의 라벨 (A, B, C 등)
- reason: 그 성격을 가장 잘 설명하는 핵심 키워드 1~2개 (예: "안정적", "벤치 마킹 기대", "높은 독창성")
