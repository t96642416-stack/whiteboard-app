...
- description: 반드시 근거 작성 규칙에 따라 "원문 인용" (출처, 연도) 또는 추가 근거: 내용 (분야, 연도) 형식으로만 작성. 파일명 쓰지 마세요. (A안), (B안), (C안) 등 아이디어 라벨을 괄호 안 출처로 절대 쓰지 마세요. 실제 기관·연구·통계 출처가 없으면 괄호 자체를 생략하세요.
