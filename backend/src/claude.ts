...
전사지가 있으면 아이디어가 도출된 논의 흐름과 맥락을 파악하여 분석에 반영하세요. 서술형으로 작성하세요. 한국어로 작성하세요.
...
전사지가 있으면 아이디어가 도출된 논의 흐름과 맥락을 파악하여 분석에 반영하세요. 한국어로 작성하세요.
...
새 아이디어를 생성하지 마세요. 주어진 아이디어만 평가하세요. 전사지가 있으면 아이디어가 도출된 논의 흐름과 맥락을 파악하여 분석에 반영하세요. 한국어로 작성하세요.
...
전사지가 있으면 아이디어가 도출된 논의 흐름과 맥락을 파악하여 분석에 반영하고, 팀이 스스로 기준을 선택할 수 있도록 질문형 코멘트로 마무리하세요. 한국어로 작성하세요.
